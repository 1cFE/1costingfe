...
basis (Account~22.01.07): $C_{220107} = c_{\text{cap}} \times
E_{\text{stored}}$, where $c_{\text{cap}}$ is the all-in installed cost
per joule (capacitors, switches, charging supplies, buswork).  The NOAK
default is \$0.50/J, reflecting mature high-volume manufacturing of
advanced-dielectric capacitors---a commercial viability requirement, not
a current capability (present lab-scale pricing is \$20--50/J).
Sensitivity to this parameter dominates the LCOE for pulsed DEC concepts.
