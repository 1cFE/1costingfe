...
\$48/MWh to LCOE \citep{Shea2010}; the DOE-allocated price of
...
\$1{,}112/kW of overnight capital). This figure sits squarely
...
(\$/MWh) \\
\midrule
Thermal only (sCO\textsubscript{2} Brayton, 47\%) & 18 & 45 & 63 \\
Pulsed inductive (85\% $\eta$, no turbine) & 23 & 22 & 45 \\
\bottomrule
\end{tabular}
\end{table}
...
contributes \$22/MWh to LCOE for the inductive architecture; at
...
inductive scheme then ends up roughly \$2/MWh higher than thermal because
...
\midrule
Thermal only (sCO\textsubscript{2}, 47\%) & 7.1 & 59 & 7.4 \\
VB DEC 60\% + thermal (hybrid) & 7.3 & 54 & 7.7 \\
Pulsed inductive (85\%, no turbine) & n/a & 35 & 9.7 \\
\bottomrule
\end{tabular}
\end{table}
...
LCOE from \$90/MWh to \$83/MWh, with a modest \$22M
increase in core cost partially offset by reduced heating-system
capacity. The pulsed inductive scheme lowers LCOE to \$67/MWh,
