...
CAS22        & Reactor plant equipment                      & 1911.9 \\
CAS23--29    & Other direct (BOP, special materials, contingency) & 242.0 \\
CAS30        & Capitalized indirect services                & 495.2 \\
CAS40        & Owner's costs                                & 24.3 \\
CAS50        & Supplementary costs                          & 185.1 \\
CAS60        & Interest during construction                 & 614.1 \\
\midrule
\multicolumn{2}{l}{Total overnight}                          & 3809.1 \\
\multicolumn{2}{l}{Overnight specific cost (\$/kW)}          & 3809 \\
\midrule
CAS70 (M\$/yr) & O\&M and scheduled replacement             & 36.3 \\
CAS80 (M\$/yr) & Fuel (raw isotopes)                        & 256.4 \\
CAS90 (M\$/yr) & Annualized financial (CRF, \cref{eq:crf})   & 307.0 \\
\midrule
\multicolumn{2}{l}{\textbf{LCOE (\$/MWh)}}                  & \textbf{78.7} \\
\bottomrule
\end{tabular}
\end{table}
...
parameter is \texttt{fuel\_recovery} (elasticity $-7.27$), in the
...
reactor-relevant densities and confinement times, $f_b$ of order 1--$10\%$.
...
$V_{\text{blk}}$ at a fuel-keyed unit cost $c_{\text{blk}}(f)$, with a
...
(about $10^4$) is sub-annual and the replacement term is prohibitive, which is
...
(\$70.6M in 2004\$ for a 1.3\,GWe stellarator, approximately \$78/kW).
...
($c_{\text{flow}}$). A separate target-size term is unnecessary: at fixed
...
The two factory archetypes differ sharply in cost. A laser or heavy-ion
...
CAS22.07 & Instrumentation \& control & 85 & $P_{\text{th}}/3500$ & 0.65 \\
\bottomrule
\end{tabular}
\end{table}
...
(M\$ at 1\,GWe reference) and the exponent 0.5 captures
...
\begin{table}[htbp]
\caption{CAS50 fuel-dependent parameters (1\,GWe reference).}
...
\midrule
D-T   & 117 & 54.9 & 55 & Tritium systems, HP dept, radwaste, remote handling \\
D-D   &  94 & 40.9 & 41 & Reduced neutron flux ($\tfrac{1}{3}$ D-T), smaller T inventory \\
D-${}^3$He &  69 & 27.5 & 28 & 5\% neutron fraction, minimal tritium \\
p-${}^{11}$B &  59 & 24.9 & 25 & Aneutronic, no tritium, RSO only \\
\bottomrule
\end{tabular}
\end{table}
...
is \$12k/MW/yr. The pB11 estimate (\$25k/MW/yr) sits at roughly
...
shell, or a 3~g lead hohlraum) marked up by tritium-confined
handling and divided by yield, the per-shot cost is about \$0.50--0.62
...
capital cost of \$2{,}829M, an overnight specific cost of
10{,}500~\$/kWe, and an LCOE of 141.4~\$/MWh under the framework's
...
% Direct: published 1521.1 M$ (1992) * 2.295 = 3491; 1cfe sum CAS21+22+23+24+25+26+27 = 3518
% Overnight $/kWe: published 2441 (1992) * 2.295 = 5602; 1cfe (CAS10-50)/kWe = 4620
% Total: published 2844 M$ (1992) * 2.295 = 6527; 1cfe total_capital = 5508
% LCOE: published 47.53 mill/kWh (1992) * 2.295 = 109.1 $/MWh; 1cfe = 74.8
\begin{table}[h]
\centering
...
\midrule
Direct cost (Account 90), M\$       & 3{,}491 & 3{,}518 &  $+0.8$ \\
Overnight specific cost, \$/kWe     & 5{,}602 & 4{,}620 & $-17.5$ \\
Total cost (Account 99), M\$        & 6{,}527 & 5{,}508 & $-15.6$ \\
LCOE, \$/MWh                        &   109.1 &    74.8 & $-31.4$ \\
\bottomrule
\end{tabular}
\end{table}

The direct-cost row matches closely (within 1\,\%), indicating
...
convention used in the ARIES program. The LCOE divergence ($-31$\,\%)
