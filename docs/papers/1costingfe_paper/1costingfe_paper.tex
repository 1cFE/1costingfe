...
\textbf{TBD} after escalation to 2025~USD. \textsc{1costingfe} predicts
an overnight capital cost of \textbf{TBD}, an overnight specific cost
of \textbf{TBD}~\$/kWe, and an LCOE of \textbf{TBD}~\$/MWh under the
framework's NOAK default assumptions. The implied delta is
