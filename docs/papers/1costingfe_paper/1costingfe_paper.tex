...
CAS22        & Reactor plant equipment                      & 1479.6 \\
CAS23--29    & Other direct (BOP, special materials, contingency) & 242.0 \\
CAS30        & Capitalized indirect services                & 409.1 \\
CAS40        & Owner's costs                                & 24.3 \\
CAS50        & Supplementary costs                          & 241.6 \\
\midrule
\multicolumn{2}{l}{Overnight capital (CAS10--50)}            & 2735.2 \\
\midrule
CAS60        & Interest during construction                 & 525.7 \\
\multicolumn{2}{l}{Total capital (incl.\ IDC)}               & 3261.0 \\
\multicolumn{2}{l}{Specific cost (\$/kW, incl.\ IDC)}        & 3261 \\
\midrule
CAS70 (M\$/yr) & O\&M and scheduled replacement             & 41.9 \\
CAS80 (M\$/yr) & Fuel (raw isotopes)                        & 250.5 \\
CAS90 (M\$/yr) & Annualized financial (CRF, \cref{eq:crf})   & 262.8 \\
\midrule
\multicolumn{2}{l}{\textbf{LCOE (\$/MWh)}}                  & \textbf{74.6} \\
\bottomrule
\end{tabular}
\end{table}
...
parameter is \texttt{fuel\_recovery} (elasticity $-7.68$), in the
physics-outputs band; the most consequential cost unit price is
\texttt{u\_he3}, the ${}^3$He purchase price ($+0.46$); and the most
consequential financial parameter is \texttt{interest\_rate} ($+0.36$).
...
elasticity of $+0.36$ and \texttt{inflation\_rate} $+0.18$.
