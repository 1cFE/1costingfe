...
CAS22        & Reactor plant equipment                      & 1579.9 \\
CAS23--29    & Other direct (BOP, special materials, contingency) & 242.0 \\
CAS30        & Capitalized indirect services                & 429.2 \\
CAS40        & Owner's costs                                & 24.3 \\
CAS50        & Supplementary costs                          & 245.9 \\
\midrule
\multicolumn{2}{l}{Overnight capital (CAS10--50)}            & 2859.9 \\
\midrule
CAS60        & Interest during construction                 & 549.7 \\
\multicolumn{2}{l}{Total capital (incl.\ IDC)}               & 3409.6 \\
\multicolumn{2}{l}{Specific cost (\$/kW, incl.\ IDC)}        & 3410 \\
\midrule
CAS70 (M\$/yr) & O\&M and scheduled replacement             & 41.9 \\
CAS80 (M\$/yr) & Fuel (raw isotopes)                        & 250.5 \\
CAS90 (M\$/yr) & Annualized financial (CRF, \cref{eq:crf})   & 274.8 \\
\midrule
\multicolumn{2}{l}{\textbf{LCOE (\$/MWh)}}                  & \textbf{76.2} \\
\bottomrule
\end{tabular}
\end{table}
...
parameter is \texttt{fuel\_recovery} (elasticity $-7.52$), in the
physics-outputs band; the most consequential cost unit price is
\texttt{u\_he3}, the ${}^3$He purchase price ($+0.45$); and the most
