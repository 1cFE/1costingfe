...
\end{equation}
The laser and heavy-ion per-joule coefficients reproduce the underlying \$/W
NOAK projections at each driver's reference repetition rate (laser $\$8$/W at
$10$~Hz gives $80$~M\$/MJ; heavy ion $\$12$/W at $5$~Hz gives $60$~M\$/MJ) and
then hold constant away from that reference.  The plasma-jet gun and the
...
\midrule
Laser IFE   & M\$/MJ & 80 & Diode-pumped solid-state laser \\
...
MagLIF      & M\$/MJ & 80 & Laser preheat; main driver in CAS22.01.07 \\
