...
\texttt{1costingfe} predicts a \$5{,}296M capital cost (19{,}617~\$/kWe)
and a 239.5~\$/MWh LCOE, a $-30$\,\% delta.
...
current REBCO price (\$1.58B, 30\,\% of capital). \texttt{1costingfe}
...
% Direct: published 1521.1 M$ (1992) * 2.295 = 3491; 1cfe sum CAS21+22+23+24+25+26+27 = 3358
% Overnight $/kWe: published 2441 (1992) * 2.295 = 5602; 1cfe (CAS10-50)/kWe = 5052
% Total: published 2844 M$ (1992) * 2.295 = 6527; 1cfe total_capital = 6023
% LCOE: published 47.53 mill/kWh (1992) * 2.295 = 109.1 $/MWh; 1cfe = 79.6
\begin{table}[h]
\centering
...
\midrule
Direct cost (Account 90), M\$       & 3{,}491 & 3{,}358 &  $-3.8$ \\
Overnight specific cost, \$/kWe     & 5{,}602 & 5{,}052 &  $-9.8$ \\
Total cost (Account 99), M\$        & 6{,}527 & 6{,}023 &  $-7.7$ \\
LCOE, \$/MWh                        &   109.1 &    79.6 & $-27.0$ \\
\bottomrule
\end{tabular}
\end{table}
...
direct cost within 4\,\% ($-3.8$\,\%), overnight specific cost within
10\,\% ($-9.8$\,\%), and total cost within 8\,\% ($-7.7$\,\%). The residual
LCOE divergence ($-27$\,\%)
