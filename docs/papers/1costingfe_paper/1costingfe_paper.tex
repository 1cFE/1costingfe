...
\end{equation}
where $c_{\text{NBI}} = 7.5$, $c_{\text{ICRF}} = 4.4$,
$c_{\text{ECRH}} = 5.3$, $c_{\text{LHCD}} = 4.2$ (all M\$/MW),
...
LHCD have no procurement anchor of comparable quality and are held
below ECRH, consistent with RF-source hardware.
