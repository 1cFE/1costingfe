...
\midrule
Tokamak     &  3.0$\times$ & 1.0 & \$500M & TF+CS+PF complexity; SPARC-class reference ($B=12$~T, $R_0=3.0$~m, $r_{\text{coil}}=2.95$~m); the reference target carries one significant figure and the markup is stated at that precision \\
...
\texttt{1costingfe}'s entire \$5.3\,B estimate, even with the coils at the
