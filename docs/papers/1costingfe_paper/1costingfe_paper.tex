...
capital cost of \$2{,}721M, an overnight specific cost of
10{,}078~\$/kWe, and an LCOE of 139.9~\$/MWh under the framework's
NOAK default assumptions. The implied delta on overnight cost is
$-64$\,\%. Sorbom's volumetric estimate uses a single \$1.06M/tonne
...
% Direct: published 1521.1 M$ (1992) * 2.295 = 3491; 1cfe sum CAS21+22+23+24+25+26+27 = 3575
% Overnight $/kWe: published 2441 (1992) * 2.295 = 5602; 1cfe (CAS10-50)/kWe = 4689
% Total: published 2844 M$ (1992) * 2.295 = 6527; 1cfe total_capital = 5591
% LCOE: published 47.53 mill/kWh (1992) * 2.295 = 109.1 $/MWh; 1cfe = 78.6
\begin{table}[h]
\centering
...
\midrule
Direct cost (Account 90), M\$       & 3{,}491 & 3{,}575 &  $+2.4$ \\
Overnight specific cost, \$/kWe     & 5{,}602 & 4{,}689 & $-16.3$ \\
Total cost (Account 99), M\$        & 6{,}527 & 5{,}591 & $-14.3$ \\
LCOE, \$/MWh                        &   109.1 &    78.6 & $-28.0$ \\
\bottomrule
\end{tabular}
\end{table}

The direct-cost row agrees within 3\,\%, indicating that the
...
cost is 16\,\% lower; this is consistent with \texttt{1costingfe}'s
NOAK default assumption replacing the FOAK-with-learning-multiplier
convention used in the ARIES program. The LCOE divergence ($-28$\,\%)
