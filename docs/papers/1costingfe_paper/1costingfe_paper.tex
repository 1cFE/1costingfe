...
solenoid coils, with count $n_{\text{central}} = \lfloor L /
d_{\text{coil}} \rfloor$ growing with chamber length at spacing
$d_{\text{coil}}$ (default 5~m), and (ii) end-plug coils with fixed
